								 ...
								 <div class="col-lg-12">
									<div class="card dz-card" id="buttons-with-icon">
										...
										<div class="tab-content" id="myTabContent-1">
											<div class="tab-pane fade show active" id="Buttons-Icon" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
	...
	&lt;button type="button" class="btn btn-dark"&gt;&lt;i class="fa-solid fa-circle-play me-2"&gt;&lt;/i&gt;Dark&lt;/button&gt;</code></pre>
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="button-light">
										<div class="card-header flex-wrap d-flex justify-content-between border-0 ">
											<div>
												<h4 class="card-title">Buttons Light</h4>
										...
										<div class="tab-content" id="myTabContent-2">
											<div class="tab-pane fade show active" id="LightStyle" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade" id="LightStyle-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="default-outline-button">
										...
										<div class="tab-content" id="myTabContent-3">
											<div class="tab-pane fade show active" id="OutlineButtons" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade " id="OutlineButtons-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="button-sizes">
										...
										<div class="tab-content" id="myTabContent-4">
											<div class="tab-pane fade show active" id="ButtonSizes" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade" id="ButtonSizes-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								  ...
								  <div class="col-lg-12">
									<div class="card dz-card" id="button-sizes-icon">
										...
										<div class="tab-content" id="myTabContent-5">
											<div class="tab-pane fade show active" id="ButtonSizesIcon" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade" id="ButtonSizesIcon-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="outline-button-sizes">
										...
										<div class="tab-content" id="myTabContent-6">
											<div class="tab-pane fade show active" id="outlineButtonSizes" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade" id="outlineButtonSizes-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="rounded-buttons">
										...
										<div class="tab-content" id="myTabContent-7">
											<div class="tab-pane fade show active" id="RoundedButtons" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade" id="RoundedButtons-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="rounded-outline-buttons">
										...
										<div class="tab-content" id="myTabContent-8">
											<div class="tab-pane fade show active" id="RoundedOutline" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade" id="RoundedOutline-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="button-right-icons">
										...
										<div class="tab-content" id="myTabContent-9">
											<div class="tab-pane fade show active" id="ButtonRightIcons" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade " id="ButtonRightIcons-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="button-left-icons">
										...
										<div class="tab-content" id="myTabContent-10">
											<div class="tab-pane fade show active" id="ButtonLeftIcons" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade" id="ButtonLeftIcons-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="square-buttons">
										...
										<div class="tab-content" id="myTabContent-11">
											<div class="tab-pane fade show active" id="SquareButtons" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade " id="SquareButtons-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="square-outline-buttons">
										...
										<div class="tab-content" id="myTabContent-12">
											<div class="tab-pane fade show active" id="SquareOutline" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade" id="SquareOutline-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="rounded-button">
										...
										<div class="tab-content" id="myTabContent-13">
											<div class="tab-pane fade show active" id="RoundedButton2" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
													<button type="button" class="btn btn-rounded btn-primary">Primary</button>
													<button type="button" class="btn btn-rounded btn-secondary">Secondary</button>
													<button type="button" class="btn btn-rounded btn-success">Success</button>
											...
											<div class="tab-pane fade " id="RoundedButton2-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
<pre class="m-0"><code class="language-html">&lt;button type="button" class="btn btn-rounded btn-primary"&gt;Primary&lt;/button&gt;
&lt;button type="button" class="btn btn-rounded btn-secondary"&gt;Secondary&lt;/button&gt;
&lt;button type="button" class="btn btn-rounded btn-success"&gt;Success&lt;/button&gt;
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="rounded-outline-buttons-1">
										...
										<div class="tab-content" id="myTabContent-14">
											<div class="tab-pane fade show active" id="RoundedOutlineButton2" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
													<button type="button" class="btn btn-rounded btn-outline-primary">Primary</button>
													<button type="button" class="btn btn-rounded btn-outline-secondary">Secondary</button>
													<button type="button" class="btn btn-rounded btn-outline-success">Success</button>
											...
											<div class="tab-pane fade " id="RoundedOutlineButton2-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="dropdown-button">
										...
										<div class="tab-content" id="myTabContent-15">
											<div class="tab-pane fade show active" id="DropdownButton" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade " id="DropdownButton-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="buttons-transparent">
										...
										<div class="tab-content" id="myTabContent-16">
											...
											<div class="tab-pane fade" id="ButtonsTransparent-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="buttons-transparent-light">
										...
										<div class="tab-content" id="myTabContent-17">
											<div class="tab-pane fade show active" id="TransparentLight" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade " id="TransparentLight-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="disabled-button">
										...
										<div class="tab-content" id="myTabContent-18">
											<div class="tab-pane fade show active" id="DisabledButton" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade" id="DisabledButton-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-lg-12">
									<div class="card dz-card" id="socia-icon-buttons">
										...
										<div class="tab-content" id="myTabContent-19">
											<div class="tab-pane fade show active" id="ButtonsName" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade" id="ButtonsName-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
...
&lt;/button&gt;</code></pre>
					 ...
					 <div class="element-menu menu-sticky sticky-header">
                        <div class="element-menu-inner" id="element-sidebar">
                            <h4 class="title mb-3">Examples For Buttom</h4>
