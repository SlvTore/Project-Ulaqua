								...
								<div class="col-xl-12">
									<div class="card dz-card" id="card-title-2">
										...
										<div class="tab-content" id="myTabContent-1">
											<div class="tab-pane fade show active" id="CardTitle2" role="tabpanel" aria-labelledby="home-tab">
											...
											<div class="tab-pane fade" id="CardTitle2-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
									...
									<div class="card dz-card text-center" id="card-title-3">
										<div class="card-header flex-wrap  border-0">
											...
											<ul class="nav nav-tabs dzm-tabs" id="myTab-2" role="tablist">
												...
												<li class="nav-item" role="presentation">
													<button class="nav-link " id="profile-tab-3" data-bs-toggle="tab" data-bs-target="#CardTitle3-html" type="button" role="tab" aria-selected="false">HTML</button>
												</li>
											</ul>
										</div>
										<div class="tab-content" id="myTabContent-3">
											<div class="tab-pane fade show active" id="CardTitle3" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade" id="CardTitle3-html" role="tabpanel" aria-labelledby="home-tab">
								...
								<div class="col-xl-12">
									<div class="card dz-card text-center" id="special-title">
										...
										<div class="tab-content" id="myTabContent-4">
											<div class="tab-pane fade show active" id="TitleTreatment" role="tabpanel" aria-labelledby="home-tab">
											...
											<div class="tab-pane fade" id="TitleTreatment-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area text-start">
								...
								<div class="col-xl-12">
									<div class="card dz-card text-white" id="primary-card">
										...
										<div class="tab-content" id="myTabContent-5">
											...
											<div class="tab-pane fade" id="Primarycard-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-xl-12">
									<div class="card dz-card text-white " id="secondary-card">
										...
										<div class="tab-content" id="myTabContent-6">
											<div class="tab-pane fade show active" id="Secondarycard" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0 mb-0">
											...
											<div class="tab-pane fade" id="Secondarycard-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-xl-12">
									<div class="card dz-card text-white" id="success-card">
										...
										<div class="tab-content" id="myTabContent-7">
											<div class="tab-pane fade show active" id="Successcard" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0 mb-0">
											...
											<div class="tab-pane fade" id="Successcard-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-xl-12">
									<div class="card dz-card text-white" id="danger-card">
										...
										<div class="tab-content" id="myTabContent-8">
											<div class="tab-pane fade show active" id="Dangercard" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0 mb-0">
											...
											<div class="tab-pane fade" id="Dangercard-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-xl-12">
									<div class="card dz-card text-white " id="warning-card">
										...
										<div class="tab-content" id="myTabContent-9">
											<div class="tab-pane fade show active" id="Warningcard" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0 mb-0">
											...
											<div class="tab-pane fade " id="Warningcard-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-xl-12">
									<div class="card dz-card text-white" id="info-card">
										...
										<div class="tab-content" id="myTabContent-10">
											<div class="tab-pane fade show active" id="Infocard" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0 mb-0">
											...
											<div class="tab-pane fade " id="Infocard-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-xl-12">
									<div class="card dz-card" id="light-card">
										...
										<div class="tab-content" id="myTabContent-11">
											<div class="tab-pane fade show active" id="Lightcard" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0 mb-0">
											...
											<div class="tab-pane fade" id="Lightcard-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-xl-12">
									<div class="card dz-card text-white" id="dark-card">
										...
										<div class="tab-content" id="myTabContent-12">
											<div class="tab-pane fade show active" id="Darkcard" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0 mb-0">
											...
											<div class="tab-pane fade" id="Darkcard-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-xl-12">
									<div class="card dz-card overflow-hidden" id="card-title-4">
										...
										<div class="tab-content" id="myTabContent-13">
											<div class="tab-pane fade show active" id="CardTitle4" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
													<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
													<p class="card-text">Last updated 3 mins ago</p>
												</div>
											</div>
											<div class="tab-pane fade" id="CardTitle4-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-xl-12">
									<div class="card dz-card overflow-hidden" id="card-title-5">
										...
										<div class="tab-content" id="myTabContent-14">
											...
											<div class="tab-pane fade" id="CardTitle5-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
<pre class="m-0"><code class="language-html">&lt;div class="card" &gt;
	&lt;img class="card-img-top img-fluid" src="{{asset('images/card/2.png')}}" alt="Card image cap"&gt;
	&lt;div class="card-header"&gt;
								...
								<div class="col-xl-12">
									<div class="card dz-card" id="card-title-6">
										...
										<div class="tab-content" id="myTabContent-15">
											<div class="tab-pane fade show active" id="CardTitle6" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0">
											...
											<div class="tab-pane fade " id="CardTitle6-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
	<pre class="m-0"><code class="language-html">&lt;div class="card"&gt;
		&lt;div class="card-header"&gt;
			&lt;h5 class="card-title"&gt;Card title&lt;/h5&gt;
	...
	&lt;/div&gt;</code></pre>
					...
					<div class="element-menu menu-sticky sticky-header">
						<div class="element-menu-inner" id="element-sidebar">
                            <h4 class="title mb-3">Examples For Card</h4>
                            <ul class="navbar-nav  element-nav" id="menu-bar">
                                <li><a href="#card-title-1" class="scroll">Card Title</a></li>
                                <li><a href="#card-title-2" class="scroll">Card Title-1</a></li>
                                <li><a href="#card-title-3" class="scroll">Card Title-2	</a></li>
