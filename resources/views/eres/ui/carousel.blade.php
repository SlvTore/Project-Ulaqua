								...
								<div class="col-xl-12">
									<div class="card dz-card" id="with-captions">
										...
										<div class="tab-content" id="myTabContent-1">
											<div class="tab-pane fade show active" id="WithCaptions" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0 p-4">
											...
											<div class="tab-pane fade " id="WithCaptions-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
								...
								<div class="col-xl-12">
									<div class="card dz-card" id="slides-only-1">
										...
										<div class="tab-content" id="myTabContent-2">
											<div class="tab-pane fade show active" id="SlidesOnly2" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0 p-4">
													<div class="bootstrap-carousel">
														<div class="carousel slide" data-bs-ride="carousel">
															<div class="carousel-inner">
											...
											<div class="tab-pane fade" id="SlidesOnly2-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
<pre class="m-0"> <code class="language-html">&lt;div class="bootstrap-carousel"&gt;
&lt;div class="carousel slide" data-bs-ride="carousel"&gt;
	&lt;div class="carousel-inner"&gt;
								...
								<div class="col-xl-12">
									<div class="card dz-card" id="slides-indicators">
										...
										<div class="tab-content" id="myTabContent-3">
											<div class="tab-pane fade show active" id="SlidesIndicators" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0 p-4">
													<div class="bootstrap-carousel">
											...
											<div class="tab-pane fade" id="SlidesIndicators-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
<pre class="m-0"> <code class="language-html">&lt;div class="bootstrap-carousel"&gt;
	&lt;div id="carouselExampleIndicators2" class="carousel slide" data-bs-ride="carousel"&gt;
		&lt;div class="carousel-indicators"&gt;
								...
								<div class="col-xl-12">
									<div class="card dz-card" id="slides-captions">
										...
										<div class="tab-content" id="myTabContent-4">
											<div class="tab-pane fade show active" id="SlidesCaptions" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body pt-0 p-4">
													<div class="bootstrap-carousel">
											...
											<div class="tab-pane fade" id="SlidesCaptions-html" role="tabpanel" aria-labelledby="home-tab">
												<div class="card-body p-0 code-area">
<pre class="m-0"><code class="language-html">&lt;div class="bootstrap-carousel"&gt;
	&lt;div data-bs-ride="carousel" class="carousel slide" id="carouselExampleCaptions"&gt;
		&lt;div class="carousel-indicators"&gt;
...
&lt;/div&gt;</code></pre>
					...
					<div class="element-menu menu-sticky sticky-header">
						<div class="element-menu-inner" id="element-sidebar">
                            <h4 class="title mb-3">Examples For Carousel</h4>
