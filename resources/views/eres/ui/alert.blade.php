                                ...
                                <div class=" col-xl-12">
                                    <div class="card dz-card" id="color-alerts">
                                        ...
                                        <div class="tab-content" id="myTabContent-1">
											<div class="tab-pane fade show active" id="colorAlerts" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body pt-0">
                                            ...
                                            <div class="tab-pane fade" id="colorAlerts-html" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
                                ...
                                <div class=" col-xl-12">
                                    <div class="card dz-card" id="square-alerts">
                                        ...
                                        <div class="tab-content" id="myTabContent-2">
											<div class="tab-pane fade show active" id="SquareAlerts" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body pt-0">
                                            ...
                                            <div class="tab-pane fade" id="SquareAlerts-html" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
                                ...
                                <div class="col-xl-12">
                                    <div class="card dz-card" id="rounded-alerts">
                                        ...
                                        <div class="tab-content" id="myTabContent-3">
											<div class="tab-pane fade show active" id="RoundedAlerts" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body pt-0">
                                            ...
                                            <div class="tab-pane fade" id="RoundedAlerts-html" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
                                ...
                                <div class="col-xl-12">
                                    <div class="card dz-card" id="dismissable-alerts">
                                        ...
                                        <div class="tab-content" id="myTabContent-4">
											<div class="tab-pane fade show active" id="DismissableAlerts" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body pt-0">
                                                    <div class="alert alert-primary alert-dismissible fade show">
                                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"><span><i class="fa-solid fa-xmark"></i></span>
                                                        </button>
                                            ...
                                            <div class="tab-pane fade" id="DismissableAlerts-html" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
                                ...
                                <div class="col-xl-12">
                                    <div class="card dz-card" id="alerts-alt">
                                        ...
                                        <div class="tab-content" id="myTabContent-5">
											<div class="tab-pane fade show active" id="AlertsAlt" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body pt-0">
                                            ...
                                            <div class="tab-pane fade " id="AlertsAlt-html" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
                                ...
                                <div class="col-xl-12 ">
                                    <div class="card dz-card" id="solid-alt">
                                        ...
                                        <div class="tab-content" id="myTabContent-6">
											<div class="tab-pane fade show active" id="SolidAlt" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body pt-0">
                                            ...
                                            <div class="tab-pane fade" id="SolidAlt-html" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
                                ...
                                <div class="col-xl-12 ">
                                    <div class="card dz-card" id="dismissable-solid">
                                        ...
                                        <div class="tab-content" id="myTabContent-7">
											<div class="tab-pane fade show active" id="Dismissable" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body pt-0">
                                                    <div class="alert alert-primary solid alert-dismissible fade show">
                                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"><span><i class="fa-solid fa-xmark"></i></span>
                                                        </button>
                                            ...
                                            <div class="tab-pane fade" id="Dismissable-html" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
    <pre class="mb-0"><code class="language-html">
    &lt;div class="alert alert-primary solid alert-dismissible fade show"&gt;
        &lt;button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"&gt;
                                ...
                                <div class="col-xl-12 ">
                                    <div class="card dz-card" id="alert-link">
                                        ...
                                        <div class="tab-content" id="myTabContent-8">
											<div class="tab-pane fade show active" id="AlertLink" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body pt-0">
                                                    <div class="alert alert-primary alert-dismissible fade show">
                                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"><span><i class="fa-solid fa-xmark"></i></span>
                                                        </button>
                                            ...
                                            <div class="tab-pane fade " id="AlertLink-html" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
<pre class="mb-0"><code class="language-html">
&lt;div class="alert alert-primary alert-dismissible fade show"&gt;
    &lt;button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"&gt;
                                ...
                                <div class=" col-xl-12">
                                    <div class="card dz-card" id="alert-link-color">
                                        ...
                                        <div class="tab-content" id="myTabContent-9">
											<div class="tab-pane fade show active" id="LinkSolid" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body pt-0">
                                                    <div class="alert alert-primary  solid alert-dismissible fade show">
                                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"><span><i class="fa-solid fa-xmark"></i></span>
                                            ...
                                            <div class="tab-pane fade " id="LinkSolid-html" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
<pre class="mb-0"><code class="language-html">
&lt;div class="alert alert-primary solid alert-dismissible fade show"&gt;
    &lt;button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"&gt;
                                ...
                                <div class="col-lg-12">
                                    <div class="card dz-card" id="notifications">
                                        ...
                                        <div class="tab-content" id="myTabContent-10">
                                            ...
                                            <div class="tab-pane fade " id="Notifications-html" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
                                    ...
                                    <div class="card dz-card" id="alert-icon-left">
                                        <div class="card-header flex-wrap d-flex justify-content-between border-0 ">
                                            ...
                                            <ul class="nav nav-tabs dzm-tabs" id="myTab-11" role="tablist">
												...
												<li class="nav-item" role="presentation">
													<button class="nav-link " id="profile-tab-11" data-bs-toggle="tab" data-bs-target="#IconLeft-html" type="button" role="tab" aria-controls="html" aria-selected="false">HTML</button>
												</li>
											</ul>
                                        </div>
                                        <div class="tab-content" id="myTabContent-11">
											<div class="tab-pane fade show active" id="IconLeft" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body pt-0">
                                            ...
                                            <div class="tab-pane fade" id="IconLeft-html" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
                                ...
                                <div class=" col-xl-12">
                                    <div class="card dz-card" id="alert-outline">
                                        ...
                                        <div class="tab-content" id="myTabContent-12">
                                            <div class="tab-pane fade show active" id="AlertOutline" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body pt-0">
                                            ...
                                            <div class="tab-pane fade " id="AlertOutline-html" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
                                ...
                                <div class=" col-xl-12">
                                    <div class="card dz-card" id="alert-social">
                                        ...
                                        <div class="tab-content" id="myTabContent-13">
                                            <div class="tab-pane fade show active" id="AlertSocial" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body pt-0">
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                            ...
                                            <div class="tab-pane fade " id="AlertSocial-html" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
<pre class="m-0"><code class="language-html">
    &lt;div class="row"&gt;
    &lt;div class="col-xl-6"&gt;
                                ...
                                <div class=" col-xl-12">
                                    <div class="card dz-card" id="message-alert">
                                        ...
                                        <div class="tab-content" id="myTabContent-14">
                                            <div class="tab-pane fade show active" id="AlertMessage" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body pt-0">
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                                            <div class="alert alert-primary alert-dismissible fade show">
                                            ...
                                            <div class="tab-pane fade" id="AlertMessage-html" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
<pre class="m-0"><code class="language-html">&lt;div class="row"&gt;
    &lt;div class="col-xl-6"&gt;
        &lt;div class="alert alert-primary alert-dismissible fade show"&gt;
                                ...
                                <div class="col-xl-12">
                                    <div class="card dz-card" id="message-alert-color">
                                        ...
                                        <div class="tab-content" id="myTabContent-15">
                                            <div class="tab-pane fade show active" id="AlertSolidcolor" role="tabpanel"    aria-labelledby="home-tab">
                                                <div class="card-body pt-0">
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                                            <div class="alert alert-primary solid alert-dismissible fade show">
                                            ...
                                            <div class="tab-pane fade" id="AlertSolidcolor-html" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
<pre class="m-0"><code class="language-html">&lt;div class="row"&gt;
    &lt;div class="col-xl-6"&gt;
        &lt;div class="alert alert-primary solid alert-dismissible fade show"&gt;
...
&lt;/div&gt;</code></pre>
                                    ...
                                    <div class="card dz-card" id="alert-icon-big">
                                        <div class="card-header flex-wrap d-flex justify-content-between border-0 ">
                                            ...
                                            <ul class="nav nav-tabs dzm-tabs" id="myTab-17" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link active " id="home-tab-17" data-bs-toggle="tab" data-bs-target="#AlertLeftIcon" type="button" role="tab"  aria-selected="true">Preview</button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link " id="profile-tab-17" data-bs-toggle="tab" data-bs-target="#AlertLeftIcon-html" type="button" role="tab"  aria-selected="false">HTML</button>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="tab-content" id="myTabContent-17">
                                            <div class="tab-pane fade show active" id="AlertLeftIcon" role="tabpanel"    aria-labelledby="home-tab">
                                                <div class="card-body pt-0">
                                                    <div class="row">
                                                        <div class="col-xl-6">
                                            ...
                                            <div class="tab-pane fade" id="AlertLeftIcon-html" role="tabpanel"    aria-labelledby="home-tab">
                                                <div class="card-body p-0 code-area">
    <pre class="m-0"><code class="language-html">&lt;div class="row"&gt;
        &lt;div class="col-xl-6"&gt;
            &lt;div class="alert alert-primary left-icon-big alert-dismissible fade show"&gt;
    ...
    &lt;/div&gt;</code> </pre>
					...
					<div class="element-menu menu-sticky sticky-header">
						...
						<h4 class="title mb-3">Examples For Alert</h4>
