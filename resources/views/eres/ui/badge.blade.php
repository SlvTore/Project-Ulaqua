							...
							<div class="col-lg-12">
								<div class="card dz-card" id="badges-light">
									...
									<div class="tab-content" id="myTabContent-1">
										<div class="tab-pane fade show active" id="BadgesLight" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body pt-0">
												<div class="bootstrap-badge">
										...
										<div class="tab-pane fade" id="BadgesLight-html" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body p-0 code-area">
<pre class="m-0"><code class="language-html">
&lt;div class="bootstrap-badge"&gt;
    &lt;span class="badge light badge-primary"&gt;Primary&lt;/span&gt;
							...
							<div class="col-lg-12">
								<div class="card dz-card" id="badges">
									...
									<div class="tab-content" id="myTabContent-2">
										<div class="tab-pane fade show active" id="Badges" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body pt-0">
												<div class="bootstrap-badge">
										...
										<div class="tab-pane fade " id="Badges-html" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body p-0 code-area">
							...
							<div class="col-lg-12">
								<div class="card dz-card"  id="pill-badge">
									...
									<div class="tab-content" id="myTabContent-3">
										<div class="tab-pane fade show active" id="PillBadge" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body pt-0">
												<div class="bootstrap-badge">
										...
										<div class="tab-pane fade" id="PillBadge-html" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body p-0 code-area">
<pre class="m-0"> <code class="language-html">
&lt;div class="bootstrap-badge"&gt;
	&lt;span class="badge badge-pill badge-primary"&gt;Pill badge&lt;/span&gt;
							...
							<div class="col-lg-12">
								<div class="card dz-card" id="link-badge">
									...
									<div class="tab-content" id="myTabContent-4">
										<div class="tab-pane fade show active" id="LinkBadge" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body pt-0">
												<div class="bootstrap-badge">
										...
										<div class="tab-pane fade" id="LinkBadge-html" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body p-0 code-area">
<pre class="m-0"><code class="language-html">&lt;div class="bootstrap-badge"&gt;
	&lt;a href="javascript:void(0)" class="badge badge-primary"&gt;Links&lt;/a&gt;
	&lt;a href="javascript:void(0)" class="badge badge-secondary"&gt;Links&lt;/a&gt;
								...
								<div class="card dz-card" id="rounded-badge">
									<div class="card-header flex-wrap d-flex justify-content-between">
										...
										<ul class="nav nav-tabs dzm-tabs" id="myTab-5" role="tablist">
											<li class="nav-item" role="presentation">
												<button class="nav-link active " id="home-tab-5" data-bs-toggle="tab" data-bs-target="#RoundedBadge" type="button" role="tab" aria-selected="true">Preview</button>
											</li>
											<li class="nav-item" role="presentation">
												<button class="nav-link " id="profile-tab-5" data-bs-toggle="tab" data-bs-target="#RoundedBadge-html" type="button" role="tab" aria-selected="false">HTML</button>
											</li>
										</ul>
									</div>
									<div class="tab-content" id="myTabContent-5">
										<div class="tab-pane fade show active" id="RoundedBadge" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body">
											<div class="bootstrap-badge">
										...
										<div class="tab-pane fade" id="RoundedBadge-html" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body p-0 code-area">
<pre class="m-0"><code class="language-html">&lt;div class="bootstrap-badge"&gt;
    &lt;a href="javascript:void(0)" class="badge badge-rounded badge-primary"&gt;Rounded&lt;/a&gt;
    &lt;a href="javascript:void(0)" class="badge badge-rounded badge-secondary"&gt;Rounded&lt;/a&gt;
								...
								<div class="card dz-card" id="rounded-outline">
									<div class="card-header flex-wrap d-flex justify-content-between ">
										...
										<ul class="nav nav-tabs dzm-tabs" id="myTab-6" role="tablist">
											<li class="nav-item" role="presentation">
												<button class="nav-link active " id="home-tab-6" data-bs-toggle="tab" data-bs-target="#OutlineBadge" type="button" role="tab" aria-selected="true">Preview</button>
											</li>
											<li class="nav-item" role="presentation">
												<button class="nav-link " id="profile-tab-6" data-bs-toggle="tab" data-bs-target="#OutlineBadge-html" type="button" role="tab"  aria-selected="false">HTML</button>
											</li>
										</ul>
									</div>
									<div class="tab-content" id="myTabContent-6">
										<div class="tab-pane fade show active" id="OutlineBadge" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body">
												<div class="bootstrap-badge">
										...
										<div class="tab-pane fade " id="OutlineBadge-html" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body p-0 code-area">
<pre class="m-0"><code class="language-html">&lt;div class="bootstrap-badge"&gt;
	&lt;a href="javascript:void(0)" class="badge badge-rounded badge-outline-primary"&gt;Rounded&lt;/a&gt;
	&lt;a href="javascript:void(0)" class="badge badge-rounded badge-outline-secondary"&gt;Rounded&lt;/a&gt;
								...
								<div class="card dz-card" id="outline-circle">
									<div class="card-header flex-wrap d-flex justify-content-between border-0 ">
										...
										<ul class="nav nav-tabs dzm-tabs" id="myTab-7" role="tablist">
											<li class="nav-item" role="presentation">
												<button class="nav-link active " id="home-tab-7" data-bs-toggle="tab" data-bs-target="#OutlineCircle" type="button" role="tab" aria-selected="true">Preview</button>
											</li>
											<li class="nav-item" role="presentation">
												<button class="nav-link " id="profile-tab-7" data-bs-toggle="tab" data-bs-target="#OutlineCircle-html" type="button" role="tab" aria-selected="false">HTML</button>
											</li>
										</ul>
									</div>
									<div class="tab-content" id="myTabContent-7">
										<div class="tab-pane fade show active" id="OutlineCircle" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body pt-0">
												<div class="bootstrap-badge">
										...
										<div class="tab-pane fade " id="OutlineCircle-html" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body p-0 code-area">
<pre class="m-0"><code class="language-html">&lt;div class="bootstrap-badge"&gt;
    &lt;a href="javascript:void(0)" class="badge badge-circle badge-outline-primary"&gt;1&lt;/a&gt;
    &lt;a href="javascript:void(0)" class="badge badge-circle badge-outline-secondary"&gt;2&lt;/a&gt;
								...
								<div class="card dz-card" id="circle-badge">
									<div class="card-header flex-wrap d-flex justify-content-between border-0 ">
										...
										<ul class="nav nav-tabs dzm-tabs" id="myTab-8" role="tablist">
											<li class="nav-item" role="presentation">
												<button class="nav-link active " id="home-tab-8" data-bs-toggle="tab" data-bs-target="#CircleBadge" type="button" role="tab" aria-selected="true">Preview</button>
											</li>
											<li class="nav-item" role="presentation">
												<button class="nav-link " id="profile-tab-8" data-bs-toggle="tab" data-bs-target="#CircleBadge-html" type="button" role="tab" aria-selected="false">HTML</button>
											</li>
										</ul>
									</div>
									<div class="tab-content" id="myTabContent-8">
										<div class="tab-pane fade show active" id="CircleBadge" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body pt-0">
												<div class="bootstrap-badge">
										...
										<div class="tab-pane fade" id="CircleBadge-html" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body p-0 code-area">
<pre class="m-0"><code class="language-html">
&lt;div class="bootstrap-badge"&gt;
    &lt;a href="javascript:void(0)" class="badge badge-circle badge-primary"&gt;1&lt;/a&gt;
								...
								<div class="card dz-card" id="circle-badge-default">
									<div class="card-header flex-wrap d-flex justify-content-between border-0 ">
										...
										<ul class="nav nav-tabs dzm-tabs" id="myTab-9" role="tablist">
											<li class="nav-item" role="presentation">
												<button class="nav-link active " id="home-tab-9" data-bs-toggle="tab" data-bs-target="#BadgeDefault" type="button" role="tab" aria-selected="true">Preview</button>
											</li>
											<li class="nav-item" role="presentation">
												<button class="nav-link " id="profile-tab-9" data-bs-toggle="tab" data-bs-target="#BadgeDefault-html" type="button" role="tab" aria-selected="false">HTML</button>
											</li>
										</ul>
									</div>
									<div class="tab-content" id="myTabContent-9">
										<div class="tab-pane fade show active" id="BadgeDefault" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body pt-0">
												<div class="bootstrap-badge">
										...
										<div class="tab-pane fade " id="BadgeDefault-html" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body p-0 code-area">
<pre class="m-0"><code class="language-html">&lt;div class="bootstrap-badge"&gt;
	&lt;a href="javascript:void(0)" class="badge badge-outline-primary"&gt;1&lt;/a&gt;
	&lt;a href="javascript:void(0)" class="badge badge-outline-secondary"&gt;2&lt;/a&gt;
								...
								<div class="card dz-card" id="number-badge">
									<div class="card-header flex-wrap d-flex justify-content-between border-0 ">
										...
										<ul class="nav nav-tabs dzm-tabs" id="myTab-10" role="tablist">
											<li class="nav-item" role="presentation">
												<button class="nav-link active " id="home-tab-10" data-bs-toggle="tab" data-bs-target="#NumberBadge" type="button" role="tab" aria-selected="true">Preview</button>
											</li>
											<li class="nav-item" role="presentation">
												<button class="nav-link " id="profile-tab-10" data-bs-toggle="tab" data-bs-target="#NumberBadge-html" type="button" role="tab" aria-selected="false">HTML</button>
											</li>
										</ul>
									</div>
									<div class="tab-content" id="myTabContent-10">
										<div class="tab-pane fade show active " id="NumberBadge" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body pt-0">
												<div class="bootstrap-badge">
										...
										<div class="tab-pane fade " id="NumberBadge-html" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body p-0 code-area">
<pre class="m-0"><code class="language-html">
&lt;div class="card-body"&gt;
    &lt;div class="bootstrap-badge"&gt;
								...
								<div class="card dz-card" id="badge-sizes">
									<div class="card-header flex-wrap d-flex justify-content-between border-0 ">
										...
										<ul class="nav nav-tabs dzm-tabs" id="myTab-11" role="tablist">
											<li class="nav-item" role="presentation">
												<button class="nav-link active " id="home-tab-11" data-bs-toggle="tab" data-bs-target="#BadgeSizes" type="button" role="tab"  aria-selected="true">Preview</button>
											</li>
											<li class="nav-item" role="presentation">
												<button class="nav-link " id="profile-tab-11" data-bs-toggle="tab" data-bs-target="#BadgeSizes-html" type="button" role="tab" aria-selected="false">HTML</button>
											</li>
										</ul>
									</div>
									<div class="tab-content" id="myTabContent-11">
										<div class="tab-pane fade show active " id="BadgeSizes" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body pt-0">
												<div class="bootstrap-badge">
										...
										<div class="tab-pane fade  " id="BadgeSizes-html" role="tabpanel" aria-labelledby="home-tab">
											<div class="card-body p-0 code-area">
												<pre class="m-0"><code class="language-html">
&lt;div class="bootstrap-badge"&gt;
    &lt;a href="javascript:void(0)" class="badge badge-xs badge-primary"&gt;xs&lt;/a&gt;
...
&lt;/div&gt;</code></pre>
					 ...
					 <div class="element-menu menu-sticky sticky-header">
						<div class="element-menu-inner" id="element-sidebar">
                            <h4 class="title">Examples For Badge</h4>
                            <ul class="navbar-nav element-nav" id="menu-bar">
                                ...
                                <li><a href="#badge-modal" class="scroll">Badge Modal</a></li>
