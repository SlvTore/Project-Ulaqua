                    ...
                    <div class="col-xl-12">
                        <div class="card dz-card" id="button-toolbar">
                            ...
                            <div class="tab-content" id="myTabContent-1">
                                <div class="tab-pane fade show active" id="ButtonToolbar" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="card-body pt-0">
                                ...
                                <div class="tab-pane fade " id="ButtonToolbar-html" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="card-body p-0 code-area">
                    ...
                    <div class="col-xl-12">
                        <div class="card dz-card" id="button-sizing">
                            ...
                            <div class="tab-content" id="myTabContent-2">
                                <div class="tab-pane fade show active" id="ButtonSizing" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="card-body pt-0">
                                ...
                                <div class="tab-pane fade " id="ButtonSizing-html" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="card-body p-0 code-area">
                    ...
                    <div class="col-xl-12">
                        <div class="card dz-card" id="button-nesting">
                            ...
                            <div class="tab-content" id="myTabContent-3">
                                <div class="tab-pane fade show active" id="ButtonNesting" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="card-body pt-0">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-primary">1</button>
                                            <button type="button" class="btn btn-primary">2</button>
                                ...
                                <div class="tab-pane fade " id="ButtonNesting-html" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="card-body p-0 code-area">
<pre class="m-0"><code class="language-html">&lt;div class="btn-group"&gt;
&lt;button type="button" class="btn btn-primary"&gt;1&lt;/button&gt;
&lt;button type="button" class="btn btn-primary"&gt;2&lt;/button&gt;
                    ...
                    <div class="col-lg-12 ">
                        <div class="card dz-card" id="vertical-variation">
                            ...
                            <div class="tab-content" id="myTabContent-4">
                                <div class="tab-pane fade show active" id="VerticalVariation" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="card-body pt-0">
                                ...
                                <div class="tab-pane fade" id="VerticalVariation-html" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="card-body p-0 code-area">
                    ...
                    <div class="col-lg-12 ">
                        <div class="card dz-card" id="vertical-dropdown">
                            ...
                            <div class="tab-content" id="myTabContent-5">
                                <div class="tab-pane fade show active" id="VerticalDropdown" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="card-body pt-0">
                                ...
                                <div class="tab-pane fade " id="VerticalDropdown-html" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="card-body p-0 code-area">
...
&lt;/div&gt;</code></pre>
        ...
        <div class="element-menu menu-sticky sticky-header">
            <div class="element-menu-inner" id="element-sidebar">
                <h4 class="title mb-3">Examples For Button Group</h4>
