                    ...
                    <div class="assigned-doctor owl-carousel">
                        <div class="items">
                            <div class="text-center">
                                <img src="{{asset('images/doctors/5.jpg')}}" alt="" >
                        ...
                        <div class="items">
                            <div class="text-center">
                                <img src="{{asset('images/doctors/1.jpg')}}" alt="" >
                        ...
                        <div class="items">
                            <div class="text-center">
                                <img src="{{asset('images/doctors/2.jpg')}}" alt="" >
                        ...
                        <div class="items">
                            <div class="text-center">
                                <img  src="{{asset('images/doctors/3.jpg')}}" alt="" >
                        ...
                        <div class="items">
                            <div class="text-center">
                                <img src="{{asset('images/doctors/4.jpg')}}" alt="" >
                    ...
                    <div id="DZ_W_Todo2" class="widget-media px-4 dz-scroll height320">
                        <ul class="timeline">
                            <li>
                                <div class="timeline-panel flex-wrap">
                                    <div class="media me-3">
                                        <img class="rounded-circle" alt="image" width="50" src="{{asset('images/widget/1.jpg')}}">
                                    </div>
                                    <div class="media-body">
                            ...
                            <li>
                                <div class="timeline-panel flex-wrap">
                                    <div class="media me-3">
                                        <img class="rounded-circle" alt="image" width="50" src="{{asset('images/widget/2.jpg')}}">
                                    </div>
                                    <div class="media-body">
                            ...
                            <li>
                                <div class="timeline-panel flex-wrap">
                                    <div class="media me-3">
                                        <img class="rounded-circle" alt="image" width="50" src="{{asset('images/widget/3.jpg')}}">
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="timeline-panel flex-wrap">
                                    <div class="media me-3">
                                        <img class="rounded-circle" alt="image" width="50" src="{{asset('images/widget/5.jpg')}}">
                                    </div>
                                    <div class="media-body">
