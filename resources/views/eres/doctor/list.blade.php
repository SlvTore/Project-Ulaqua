...
<div class="container-fluid">
    <div class="form-head d-flex mb-3 mb-md-4 align-items-start">
        <div class="me-auto d-lg-block">
            <a href="{{url('doctor-detail')}}" class="btn btn-primary btn-rounded">+ Add New</a>
        </div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <img alt="" src="{{asset('images/doctors/9.jpg')}}" height="43" width="43" class="rounded-circle ms-4">
                                </div>
                            </td>
                            <td>#P-00012</td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <img alt="" src="{{asset('images/doctors/10.jpg')}}" height="43" width="43" class="rounded-circle ms-4">
                                </div>
                            </td>
                            <td>#P-00016</td>
                            <td>26/02/2020, 12:42 AM</td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <img alt="" src="{{asset('images/doctors/11.jpg')}}" height="43" width="43" class="rounded-circle ms-4">
                                </div>
                            </td>
                            <td>#P-00015</td>
                            <td>26/02/2020, 12:42 AM</td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <img alt="" src="{{asset('images/doctors/12.jpg')}}" height="43" width="43" class="rounded-circle ms-4">
                                </div>
                            </td>
                            <td>#P-00014</td>
                            <td>26/02/2020, 12:42 AM</td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <img alt="" src="{{asset('images/doctors/13.jpg')}}" height="43" width="43" class="rounded-circle ms-4">
                                </div>
                            </td>
                            <td>#P-00013</td>
                            <td>26/02/2020, 12:42 AM</td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <img alt="" src="{{asset('images/doctors/14.jpg')}}" height="43" width="43" class="rounded-circle ms-4">
                                </div>
                            </td>
                            <td>#P-00017</td>
                            <td>26/02/2020, 12:42 AM</td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <img alt="" src="{{asset('images/doctors/15.jpg')}}" height="43" width="43" class="rounded-circle ms-4">
                                </div>
                            </td>
                            <td>#P-00018</td>
                            <td>26/02/2020, 12:42 AM</td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <img alt="" src="{{asset('images/doctors/16.jpg')}}" height="43" width="43" class="rounded-circle ms-4">
                                </div>
                            </td>
                            <td>#P-00019</td>
                            <td>26/02/2020, 12:42 AM</td>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <img alt="" src="{{asset('images/doctors/1.jpg')}}" height="43" width="43" class="rounded-circle ms-4">
                                </div>
                            </td>
                            <td>#P-00012</td>
                            <td>26/02/2020, 12:42 AM</td>
