...
<div class="container-fluid">
    ...
    <div class="d-block d-sm-flex mb-3 mb-md-4">
        ...
        <select class="default-select ms-auto me-1 image-select style-2">
            <option data-thumbnail="{{asset('images/svg/check-circle 1.svg')}}" data-content="<img src='{{asset('images/svg/check-circle 1.svg')}}'/>">Available</option>
            <option data-thumbnail="{{asset('images/svg/check-circle 1.svg')}}" data-content="<img src='{{asset('images/svg/check-circle 1.svg')}}'/>">Daily</option>
            <option data-thumbnail="{{asset('images/svg/check-circle 1.svg')}}" data-content="<img src='{{asset('images/svg/check-circle 1.svg')}}'/>">Weekly</option>
            <option data-thumbnail="{{asset('images/svg/check-circle 1.svg')}}" data-content="<img src='{{asset('images/svg/check-circle 1.svg')}}'/>">Monthly</option>
        </select>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="media d-sm-flex d-block text-center text-sm-start pb-4 mb-4 border-bottom">
                        <img alt="image" class="rounded me-sm-4 me-0" width="130" src="{{asset('images/avatar/1.jpg')}}">
            ...
            <div class="assigned-doctor2 owl-carousel">
                <div class="items">
                    <div class="media bg-white p-4 rounded align-items-center">
                        <img class="me-3" src="{{asset('images/doctors/6.jpg')}}" alt="">
                ...
                <div class="items">
                    <div class="media bg-white p-4 rounded align-items-center">
                        <img class="me-3" src="{{asset('images/doctors/7.jpg')}}" alt="">
                        <div class="media-body d-block d-sm-flex  align-items-center justify-content-between">
                            <div class="me-2">
                ...
                <div class="items">
                    <div class="media bg-white p-4 rounded align-items-center">
                        <img class="me-3" src="{{asset('images/doctors/8.jpg')}}" alt="">
                        <div class="media-body d-block d-sm-flex  align-items-center justify-content-between">
                            <div class="me-2">
