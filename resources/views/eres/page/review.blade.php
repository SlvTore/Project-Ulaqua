                ...
                <div id="navpills-1" class="tab-pane active">
                    <div class="card review-table">
                        <div class="media align-items-center">
                            ...
                            <img class="me-3 img-fluid rounded" width="90" src="{{asset('images/doctors/6.jpg')}}" alt="DexignZone">
                    ...
                    <div class="card review-table">
                        <div class="media align-items-center">
                            ...
                            <img class="me-3 img-fluid rounded" width="90" src="{{asset('images/doctors/17.jpg')}}" alt="DexignZone">
                            <div class="media-body d-lg-flex d-block row align-items-center">
                                <div class="col-xl-4 col-xxl-5 col-lg-12 review-bx">
                    ...
                    <div class="card review-table">
                        <div class="media align-items-center">
                            ...
                            <img class="me-3 img-fluid rounded" width="90" src="{{asset('images/doctors/18.jpg')}}" alt="DexignZone">
                            <div class="media-body d-lg-flex d-block row align-items-center">
                                <div class="col-xl-4 col-xxl-5 col-lg-12 review-bx">
                    ...
                    <div class="card review-table">
                        <div class="media align-items-center">
                            ...
                            <img class="me-3 img-fluid rounded" width="90" src="{{asset('images/doctors/19.jpg')}}" alt="DexignZone">
                            <div class="media-body d-lg-flex d-block row align-items-center">
                                <div class="col-xl-4 col-xxl-5 col-lg-12 review-bx">
                    ...
                    <div class="card review-table">
                        <div class="media align-items-center">
                            ...
                            <img class="me-3 img-fluid rounded" width="90" src="{{asset('images/doctors/20.jpg')}}" alt="DexignZone">
                            <div class="media-body d-lg-flex d-block row align-items-center">
                                <div class="col-xl-4 col-xxl-5 col-lg-12 review-bx">
                ...
                <div id="navpills-3" class="tab-pane">
                    ...
                    <div class="card review-table">
                        <div class="media align-items-center">
                            ...
                            <img class="me-3 img-fluid rounded" width="90" src="{{asset('images/doctors/7.jpg')}}" alt="DexignZone">
                            <div class="media-body d-lg-flex d-block row align-items-center">
                                <div class="col-xl-4 col-xxl-5 col-lg-12 review-bx">
                                    <h3 class="fs-20 font-w600 mb-1"><a class="text-black" href="javascript:void(0);">Brian Lucky</a></h3>
                                    <span class="fs-15 d-block">Sunday, 24 July 2020   04:55 PM</span>
