                            ...
                            <div class="card-body">
                                <div class="profile-interest">
                                    ...
                                    <div class="row mt-4 sp4" id="lightgallery">
                                        <a href="{{asset('images//big/img6.jpg')}}"  data-src="{{asset('images/big/img6.jpg')}}" class=" lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                            <img src="{{asset('images/big/img6.jpg')}}" alt="" class="img-fluid">
                                        </a>

                                        <a href="{{asset('images//big/img5.jpg')}}"  data-src="{{asset('images/big/img5.jpg')}}" class=" lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                            <img src="{{asset('images/big/img5.jpg')}}" alt="" class="img-fluid">
                                        </a>
                                        <a href="{{asset('images//big/img4.jpg')}}"  data-src="{{asset('images/big/img4.jpg')}}" class=" lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                            <img src="{{asset('images/big/img4.jpg')}}" alt="" class="img-fluid">
                                        </a>
                                        <a href="{{asset('images//big/img5.jpg')}}" data-src="{{asset('images/big/img5.jpg')}}" class=" lg-item mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                            <img src="{{asset('images/big/img5.jpg')}}" alt="" class="img-fluid">
                                        </a>
                    ...
                    <div class="card-body">
                        <div class="post-details">
                            ...
                            <ul class="mb-4 post-meta d-flex flex-wrap">
                                ...
                                <li class="post-date me-3"><i class="fa-solid fa-calendar me-2"></i>18 Nov 2020</li>
