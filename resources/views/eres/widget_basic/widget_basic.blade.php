    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-xxl-6 col-lg-6">
            <div class="card p-0">
                ...
                <div class="card-body p-0">
                    <div id="DZ_W_TimeLine111" class="widget-timeline dz-scroll my-4 px-4 style-1 height370">
                        <ul class="timeline">
                            <li>
                                <div class="timeline-badge primary"></div>
                                <a class="timeline-panel text-muted" href="javascript:void(0);">
            ...
            <div class="card active_users">
                ...
                <div class="card-body pt-0">
                    <div class="list-group-flush mt-4">
                        <div class="list-group-item bg-transparent d-flex justify-content-between px-0 py-1 font-weight-semi-bold border-0 border-bottom">
