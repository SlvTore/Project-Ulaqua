...
<div class="container-fluid">
    ...
    <div class="d-md-flex d-block mb-3 align-items-center">
        ...
        <select class="default-select ms-auto me-1 image-select style-2">
            <option data-thumbnail="{{asset('images/svg/check-circle 1.svg')}}" data-content="<img src="{{asset('images/svg/check-circle 1.svg')}}/>">Recovered</option>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="media d-sm-flex text-sm-start d-block text-center">
                        <img alt="image" class="rounded me-sm-4 me-0 mb-2 mb-sm-0" width="130" src="{{asset('images/avatar/2.jpg')}}">
                        <div class="media-body">
