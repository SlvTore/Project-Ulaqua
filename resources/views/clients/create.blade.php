...
<div class="container-fluid">
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h4>Tambah Klien Baru</h4>
                <span>Masukkan data identitas klien dengan detail</span>
            </div>
        </div>
    ...
    <!-- Menampilkan pesan error validasi dasar (opsional) -->
    @if ($errors->any())
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Form Data Klien</h4>
                </div>
                <div class="card-body">
                        ...
                        <form action="{{ route('clients.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="name" class="form-control form-control-lg @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Masukkan nama klien" required>
                                    @error('name')
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="email" name="email" class="form-control form-control-lg @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="Contoh: klien@email.com">
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="phone" class="form-control form-control-lg @error('phone') is-invalid @enderror" value="{{ old('phone') }}" placeholder="Contoh: 08123456789">
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mt-4">
                                <button type="submit" class="btn btn-primary d-inline-block rounded-square"><i class="fa fa-save me-2"></i> Simpan Data</button>
