...
const CTASection = ({
  ...
  description = "We give our services to more than 10 countries. We give our delivery service using more than 50 couriers within 2hr in anywhere in the city.",
  ...
  return (
    <section className={`cta-section ${backgroundColor}`}>
      ...
      <div className="auto-container">
        <div className={`row align-items-center clearfix ${reverse ? 'flex-row-reverse' : ''}`}>
          <div className="col-lg-6 col-md-12 col-sm-12 image-column">
            <figure className="image-box wow slideInLeft animated clearfix" data-wow-delay="00ms" data-wow-duration="1500ms">
